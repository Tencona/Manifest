// TODO ConsoleCommands needs an overhaul, or needs to be removed entirely.
...
// 		let matchedType = userInput.args.find(args => args.name === `type`);
...
// 					result.payload = { item, type: matchedType }; // Override payload so lastItem and lastType can both be updated
// 					return result;
// 				}
// 				break;
// 			case `type`:
...
// 				break;
// 			default:
// 				console.error(`Unhandled case: ${userInput.args[0].name}`);
// 				break;
// 		}
// 	}
// 	// #endregion
